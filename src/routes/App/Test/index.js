                    ...
                    <div className="card ">
                        <div className="card-header">
                            ...
                            <div className="card-header-action">
                                <DropdownButton title="View" color="primary">
                                    <DropdownItem href="#">First </DropdownItem>
                                </DropdownButton>
                        ...
                        <div className="card-body">
                            <div className="support-ticket media pb-1 mb-3">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="my-1">
                                        Hi, can you please add new table for
                                        advan...
                                    </p>
                            ...
                            <div className="support-ticket media pb-1 mb-3">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="my-1">
                                        please check select item in advance form
                                        not work...
                                    </p>
                                    <small className="text-muted">
                                        Created by{" "}
                            ...
                            <div className="support-ticket media pb-1 mb-3">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="my-1">
                                        can you provide template in latest
                                        angular 8.
                                    </p>
                                    <small className="text-muted">
                                        Created by{" "}
                            ...
                            <div className="support-ticket media pb-1 mb-3">
                                ...
                                <div className="media-body ml-3">
                                    ...
                                    <p className="my-1">
                                        Hi, John, can you work on increase page
                                        speed of template...
                                    </p>
                                    <small className="text-muted">
                                        Created by{" "}
